...
0. Это инструкция, как подготовить справочник кракозябр,
...
1. Генерирем 2 текстовых файла: bad.txt и good.txt,
...
2. Копируем в директорию с файлами скрипт generateSerializedMap.php и запускаем.
...
3. Копируем в директорию с файлами скрипт converter.php.

Копируем содержимое файла serializedMap.txt в переменную $map в файле converter.php.



4. Копируем текстовый файл с кракозябрами (файл должен быть в кодировке utf8)
